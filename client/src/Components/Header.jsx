...
return (
    ...
    <Link to={"/"} href="gg" className="flex items-center gap-1"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-8 h-8">
...
{user ? <div className='text-gray-500'>{user.name}</div> : <div className='text-gray-500'>Login</div>}
</Link>
</header>
